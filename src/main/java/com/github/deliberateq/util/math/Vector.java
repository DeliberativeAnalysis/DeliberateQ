...
public final class Vector extends Matrix {
	...
	public double getBestCorrelatedRotation(Vector v2, final Vector v) {
		...
		final com.github.deliberateq.util.math.Function f = new com.github.deliberateq.util.math.Function() {
			@Override
		...
		final com.github.deliberateq.util.math.Function fd = new com.github.deliberateq.util.math.Function() {
